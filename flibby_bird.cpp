...
void instructions()
 {
	...
	second->data ="Press spacebar to make bird fly\n"; // assign data to second node
	second->next = third;

	third->data ="Press any key to go back to menu\n"; // assign data to third node
	third->next = NULL;
...
{ // at first we want to set cursor of the game
	...
	head->data = " 1-Start Game\n"; // assign data in first node
	head->next = second; // Link first node with second

	second->data ="2-Instructions\n"; // assign data to second node
	second->next = third;

	third->data ="3-Quit Game\n"; // assign data to third node
	third->next = NULL;
